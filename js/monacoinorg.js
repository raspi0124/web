   ...
   $('select').change(function() {
    ...
    switch (val) {
      ...
      case "en":
        ...
        ttxt = "";
        dtxt = '<div class="col-lg-8 col-lg-offset-2" style="margin-top:30px;"><a href="https://github.com/monacoinproject/monacoin/blob/master-0.15/doc/release-notes-monacoin.md" class="btn btn-default btn-lg btn-download" target="_blank" >release notes</a></div></div>';
        ltxt = "";
        break;
      default:
        atxt = "";
